	...
	public static function comparison($check1, $operator = null, $check2 = null) {
		...
		switch ($operator) {
			...
			case '!=':
				...
				break;
			default:
				static::$errors[] = sprintf('You must define the $operator parameter for %s', 'Validation::comparison()');
		}
		return false;
	}
 ...
 */
	public static function custom($check, $regex = null) {
		...
		if ($regex === null) {
			static::$errors[] = sprintf('You must define a regular expression for %s', 'Validation::custom()');
			return false;
		}
